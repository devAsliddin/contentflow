...
function Step2Caption({ draft, onDraftUpdate, onNext, onBack }: Step2Props) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex gap-3 pt-2">
        ...
        <button
          onClick={handleNext}
          className="flex items-center gap-2 px-6 py-2 rounded-xl bg-indigo-500 text-white text-sm font-medium hover:bg-indigo-400 transition"
        >
          Rasm qadami
          <ArrowRight size={15} />
        </button>
