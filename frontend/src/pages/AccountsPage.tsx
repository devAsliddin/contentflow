...
function AddCard({ label, hint, onClick }: { kind: PlatformKey; label: string; hint: string; onClick: () => void }) {
  return (
    <button
      onClick={onClick}
...
function TikTokConnectForm({ onSuccess: _onSuccess }: { onSuccess: () => void }) {
  const [loading, setLoading] = useState(false)
